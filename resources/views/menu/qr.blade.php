...
<div class="text-center py-6 border-b border-orange-200">
        <img src="{{ asset('images/kanca-logo.jpg') }}" alt="Kanca Coffee" class="w-12 h-12 rounded-2xl object-cover mx-auto shadow-lg" />
...
<div class="flex items-center gap-2 mb-3">
                    <i data-lucide="{{ $category->slug == 'coffee' ? 'coffee' : ($category->slug == 'non-coffee' ? 'milk' : ($category->slug == 'tea' ? 'cup-soda' : ($category->slug == 'meals' ? 'utensils-crossed' : ($category->slug == 'pastry' ? 'croissant' : 'cake')))) }}" class="w-5 h-5 text-kanca-orange"></i>
...
<div class="mt-8 text-center text-xs text-gray-400 inline-flex items-center gap-1.5">
        <i data-lucide="coffee" class="w-4 h-4"></i> Silakan beri tahu barista kami di konter untuk memesan!
    </div>
